...
fname = "./RubiksCube-TwophaseSolver/conj_twist"
...
fname = "./RubiksCube-TwophaseSolver/conj_ud_edges"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname1 = "./RubiksCube-TwophaseSolver/fs_classidx"
fname2 = "./RubiksCube-TwophaseSolver/fs_sym"
fname3 = "./RubiksCube-TwophaseSolver/fs_rep"
...
fname1 = "./RubiksCube-TwophaseSolver/co_classidx"
fname2 = "./RubiksCube-TwophaseSolver/co_sym"
fname3 = "./RubiksCube-TwophaseSolver/co_rep"
if not (path.isfile(fname1) and path.isfile(fname2) and path.isfile(fname3)):
