...
fname = "./RubiksCube-TwophaseSolver/move_twist"
...
fname = "./RubiksCube-TwophaseSolver/move_flip"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = "./RubiksCube-TwophaseSolver/move_slice_sorted"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = "./RubiksCube-TwophaseSolver/move_u_edges"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = "./RubiksCube-TwophaseSolver/move_d_edges"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = "./RubiksCube-TwophaseSolver/move_ud_edges"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = "./RubiksCube-TwophaseSolver/move_corners"
if not path.isfile(fname):
    print("creating " + fname + " table...")
